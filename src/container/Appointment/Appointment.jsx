...
const Appointment = () => {
  ...
  <div className='book__wrapper'>
    ...
    <form className='book__wrapper-section section__padding'>
      ...
      <div className='book__wrapper-section_fragment section__padding'>
        ...
        <div className='book__wrapper-section_fragment-FullName flex box1'>
          ...
          <div className='flex section__margin'>
            <div>
              <input type='text'/>
        ...
        <div className='book__wrapper-section_fragment-Photos box9'>
        ...
        <div className='book__wrapper-section_fragment-Skin box10'>
        ...
        <div className='book__wrapper-section_fragment-Description flex box11'>
          ...
          <textarea className='section__margin' placeholder='Please provide us with a detailed description of your tattoo concept...'/>
        </div>
